...
export interface RouterOptions {
  maxMessageSize?: number; // 最大消息大小限制（字节）
}
...
export class MessageRouter {
  ...
  private static readonly DEFAULT_MAX_MESSAGE_SIZE = 64 * 1024; // 64KB
  
  // Bug 2 修复: 定义禁止订阅的消息类型列表
  private static readonly RESERVED_TYPES = ['error'];
   ...
   */
  subscribe(type: string, callback: (msg: Message) => void): SubscribeResult {
